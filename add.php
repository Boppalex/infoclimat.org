...
<body class="bg-gray-100">
    <form method="post" class="max-w-md mx-auto my-8 p-6 bg-white rounded shadow-md">
        ...
        <div class="flex flex-row">
            <button type="submit"
                class="bg-green-600 text-white py-2 px-4 rounded hover:bg-green-700 focus:outline-none focus:shadow-outline-green">Enregistrer</button>
            <a href="backend.php"
                class="block mx-auto mt-4 bg-green-600 text-white py-2 px-4 rounded hover:bg-green-700 focus:outline-none focus:shadow-outline-green  left-0 right-0">Retour</a>
        </div>
